...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_7->setMinimumSize(QSize(132, 0));
        QFont font;
        ...
        label_17->setMinimumSize(QSize(125, 0));
        ...
        label_8->setMinimumSize(QSize(89, 0));
        ...
        label_18->setMinimumSize(QSize(89, 0));
        ...
        label_19->setMinimumSize(QSize(82, 0));
        ...
        sizePolicy2.setHeightForWidth(frame_22->sizePolicy().hasHeightForWidth());
        frame_22->setSizePolicy(sizePolicy2);
        ...
        label_25->setMinimumSize(QSize(115, 0));
        ...
        sizePolicy2.setHeightForWidth(frame_23->sizePolicy().hasHeightForWidth());
        frame_23->setSizePolicy(sizePolicy2);
        ...
        label_26->setMinimumSize(QSize(115, 0));
        ...
        sizePolicy2.setHeightForWidth(frame_24->sizePolicy().hasHeightForWidth());
        frame_24->setSizePolicy(sizePolicy2);
        ...
        label_27->setMinimumSize(QSize(115, 0));
        ...
        sizePolicy2.setHeightForWidth(frame_25->sizePolicy().hasHeightForWidth());
        frame_25->setSizePolicy(sizePolicy2);
        ...
        label_28->setMinimumSize(QSize(115, 0));
        ...
        label_20->setMinimumSize(QSize(175, 0));
        ...
        label_21->setMinimumSize(QSize(175, 0));
        ...
        sizePolicy1.setHeightForWidth(x_coord_label->sizePolicy().hasHeightForWidth());
        x_coord_label->setSizePolicy(sizePolicy1);
        x_coord_label->setMinimumSize(QSize(68, 0));
        x_coord_label->setFrameShape(QFrame::WinPanel);
        x_coord_label->setFrameShadow(QFrame::Sunken);

        gridLayout_4->addWidget(x_coord_label, 0, 2, 1, 1);

        y_coord_label = new QLabel(frame_21);
        y_coord_label->setObjectName(QString::fromUtf8("y_coord_label"));
        sizePolicy1.setHeightForWidth(y_coord_label->sizePolicy().hasHeightForWidth());
        y_coord_label->setSizePolicy(sizePolicy1);
        y_coord_label->setMinimumSize(QSize(68, 0));
        y_coord_label->setFrameShape(QFrame::WinPanel);
        y_coord_label->setFrameShadow(QFrame::Sunken);

        gridLayout_4->addWidget(y_coord_label, 0, 1, 1, 1);
...
"background: rgb(255, 255, 127)"));
        ...
        sizePolicy4.setHeightForWidth(tank_stop->sizePolicy().hasHeightForWidth());
        tank_stop->setSizePolicy(sizePolicy4);
...
"color: red;"));
        ...
        sizePolicy5.setHeightForWidth(protection->sizePolicy().hasHeightForWidth());
        protection->setSizePolicy(sizePolicy5);
